...
export const sendEmail = (email, token) => {
  const mailData = {
    ...
    html: `<center><img src="https://i.imgur.com/9QUE4dJ.png"></img></center> <br>
    Thank you for creating an account in <b>DemoReset</b>. To complete the registration process, we need to verify your email address. <br>
      ...
      <a href="http://localhost:3000/auth/validate/${token}">Validate account</a> <br>
...
export const sendEmailRecoveryPassword = (email, token, first_name, last_name) => {
  const mailData = {
    ...
    We have received a request to reset your password for your account with us. To complete the process, please click on the following link: <a href="http://localhost:3000/auth/forgotpassword/${token}">Recover Password</a> <br>
